...
app = Client("Channel - app",api_id=21943556,api_hash="646d0a2ddb943a9cfc45684652252e64",bot_token="6990304610:AAGOOQfdf6sb599n10hKMfAS1t-zx9kPWQQ")
...
async def START(c:Client,m:Message):
	...
	ارسل رسالتك وسيتم الرد عليك قريبا
		...
		con.commit()
		try:
			await app.send_message(6488920279,f"""
		<u>«**New User**»</u>
	...
	في بوت التواصل الخاص بي
	ارسل رسالتك وسيتم الرد عليك قريبا
		""",reply_markup=InlineKeyboardMarkup ([[InlineKeyboardButton ("Dev",user_id=6488920279)]]),quote= True)
		

	
@app.on_message(filters.command("تفعيل التواصل","") & filters.user(6488920279) & filters.private)
...
@app.on_message(filters.command("تعطيل التواصل","") & filters.user(6488920279) & filters.private)
...
@app.on_message(filters.command("الاحصائيات","") & filters.user(6488920279) & filters.private)
...
@app.on_message(filters.command("اذاعه للكل","") & filters.user(6488920279) & filters.private)
...
@app.on_message(filters.command("حظر عضو","") & filters.user(6488920279) & filters.private)
...
@app.on_message(filters.command("الغاء حظر عضو","") & filters.user(6488920279) & filters.private)
...
@app.on_message(filters.private & ~filters.command("start") & ~filters.user(6488920279))
async def Private(c:Client,m:Message):
	...
	if CHECK_BAND(user_id=m.from_user.id):
		...
		await app.copy_message(chat_id=6488920279,
